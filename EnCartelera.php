				 ...
				 //FALTA CREAR LOGOUT
 				 echo '<a href="mis_calificadas.php"><h2>Mis peliculas calificadas</h2></a>';
									...
									<li class="subindice">
										...
										<ul >
											<li>
												<form id="search" method="get" action="BusquedaAno1.php">
...
<header>
	    <h2>EN CARTELERA</h2>
						...
						<table class="tablaPeliculas">
							...
							$URL_API = "https://api.themoviedb.org/3/movie/now_playing?api_key=c7f7381bc44cd24b332ccc18f24fc126";
						...
						<p><a href="EnCartelera_pg2.php">Pagina Siguente</a></p>
