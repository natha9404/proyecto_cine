<?PHP
    class ORM_PeliculasPorCategoria {
        private static $basedatos;
        protected static $tabla = 'pelicula_categoria';
        ...
        public static function encontrar($id){
            $resultado = self::where('id_categoria', $id);
            return $resultado[0];
        }
        ...
        public function save() {
            ...
            if ($this->id) {
                ...
                $columns.= ' = ?';
                $query = "UPDATE " . static ::$table . " SET $columns WHERE id_categoria =" . $this->id;
            } else {
