...
<form action="procesar.php" method="POST">
     ...
     <div class="form-group log-status">
       <input type="password" class="form-control" placeholder="Contraseña" name="Passwod">
       <i class="fa fa-lock"></i>
      <div class="form-group log-status">
       <input type="password" class="form-control" placeholder="Confirmar Contraseña" name="Confirmar">
       <i class="fa fa-lock"></i>  
     </div>
     <div class="form-group">
       <input type="date" class="form-control" placeholder="Fecha de Nacimiento" name="fecha" min="1900-01-01" max="1998-07-13">
